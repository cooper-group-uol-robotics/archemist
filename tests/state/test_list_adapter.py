...
class ListAdapterTest(unittest.TestCase):
    def test_op_list(self):
        ...
        test_model = TestModel(robot_ops=robot_op_models, station_ops=station_op_models, batches=batch_models)
        test_model.save()
        ...
        # get operation
        self.assertEqual(station_ops_list[0].target_temperature, station_op1.target_temperature)
