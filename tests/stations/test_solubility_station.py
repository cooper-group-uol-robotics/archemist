...
class SolubilityStationTest(unittest.TestCase, ProcessTestingMixin):
    def setUp(self):
        self.station_doc = {
            ...
            {
                'type': 'SolubilityStationProcess',
                'args': {}
            },
            'parameters':{}
        }

        self.station = SolubilityStation.from_dict(self.station_doc, [], [])
    ...
    def test_state(self):
        ...
        self.assertEqual(ret_t_op.solubility_state, SolubilityState.DISSOLVED)
    ...
    def test_solubility_station_process(self):
        ...
        process = SolubilityStationProcess(self.station, process_data)
        ...
        for i in range(self.station_doc['process_batch_capacity']):
            for j in range(num_samples):
                ...
                self.assert_station_op(station_op, 'SolubilityOpDescriptor')
