...
# from archemist.stations.lightbox_station.state import (
#     LightBoxStation,
#     SampleColorOpDescriptor,
# )
...
#         t_op = IKAHeatingStirringOpDescriptor.from_args(
#             temperature=140, stirring_speed=500, duration=10
#         )
#         self.assertFalse(t_op.has_result)
...
#         # construct station ops
#         t_op = QuantosDispenseOpDescriptor.from_args(
#             solid_name="salt", dispense_mass=1.2
#         )
#         self.assertFalse(t_op.has_result)
#         t_station.assign_station_op(t_op)
#         self.assertEqual(t_station.state, StationState.OP_ASSIGNED)
...
#         # construct station ops
#         t_op = PeristalticPumpOpDescriptor.from_args(
#             liquid_name="water", dispense_volume=100
#         )
#         self.assertFalse(t_op.has_result)
#         t_station.assign_station_op(t_op)
#         self.assertEqual(t_station.state, StationState.OP_ASSIGNED)
...
#         self.assertEqual(t_station.state, StationState.OP_ASSIGNED)
#         t_station.complete_assigned_station_op(
#             True, turbidity_state=TurbidityState.DISSOLVED
#         )
#         t_station.set_to_processing()
#         self.assertEqual(t_station.state, StationState.PROCESSING)
#         ret_op = t_station.station_op_history[0]
