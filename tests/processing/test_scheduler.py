...
class SchedulerTest(unittest.TestCase):
    ...
    def test_priority_queue_scheduler_fixed_robot(self):
        ...
        op_1 = RobotTaskOpDescriptor.from_args("load_rack", "FixedRobot",
                                            ...
                                            origin_station_id=requester_object_id)
        ...
        op_5 = RobotMaintenanceOpDescriptor.from_args("calibrate", "FixedRobot", 187)
    ...
    def test_priority_queue_scheduler_mobile_robot(self):
        ...
        s2_nav_op_1 = RobotNavOpDescriptor.from_args("move_to_s2", "MobileRobot",
                                            ...
                                            origin_station_id=self.station_2.object_id,)
        ...
        # add s2 robot ops
        s2_wait_op_2 = RobotWaitOpDescriptor.from_args("MobileRobot", 5,
                                            origin_station_id=self.station_2.object_id)
        ...
        s3_man_op_1 = RobotTaskOpDescriptor.from_args("image_vial", "MobileRobot",
                                            RobotTaskType.MANIPULATION, {"index": 0},
                                            origin_station_id=self.station_3.object_id,
                                            related_batch=batch_1, related_lot=lot_1)
        ...
        s4_unload_op_1 = RobotTaskOpDescriptor.from_args("unload_rack", "MobileRobot",
                                            RobotTaskType.UNLOAD_FROM_ROBOT, {"index": 0},
                                            origin_station_id=self.station_4.object_id,
                                            related_batch=batch_1, related_lot=lot_1)
