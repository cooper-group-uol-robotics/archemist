...
class ArchemistServer:
    ...
    def __init__(self, workflow_dir: Path, existing_db: bool = False) -> None:
        ...
        self._server_config = YamlHandler.load_server_settings_file(
        ...
        if not existing_db:
            ...
            self._state = persistence_mgr.construct_state_from_config_file(
            ...
            try:
                ...
                if msg.category == CMDCategory.WORKFLOW:
                    ...
                    if msg.cmd == "get_list":
                        ...
                        self._workflow_mgr.queue_robot_op(
