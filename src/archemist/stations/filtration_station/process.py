...
class FiltrationStationSm(StationProcessFSM):
    ...
    def __init__(self, station: Station, params_dict: Dict):
        ...
        states = [ State(name='init_state'), 
            ...
            State(name='filteration_process', on_enter=['request_process_operation']),
        ...
        ''' Transitions '''
        transitions = [
            {'trigger':self._trigger_function, 'source':'init_state', 'dest': 'open_drain_valve', 'conditions':'all_batches_assigned'},
            {'trigger':self._trigger_function, 'source':'open_drain_valve','dest':'draining_process', 'conditions':'is_station_job_ready'},
            {'trigger':self._trigger_function, 'source':'draining_process','dest':'close_drain_valve', 'conditions':['is_station_job_ready','is_draining_process_complete']},
    ...
    def request_process_operation (self):
        ...
        self._status['filteration_complete'] = True
    ...
    def is_draining_process_complete(self):
