from .model import PeristalticPumpOpDescriptorModel, PeristalticPumpStationModel
...
class PeristalticPumpOpDescriptor(StationOpDescriptor):
    ...
    def from_args(cls, **kwargs):
        ...
        cls._set_model_common_fields(model, associated_station=PeristalticLiquidDispensing.__name__, **kwargs)
