...
from .state import WeighingStation, SampleWeighingOpDescriptor
...
class WeighingSM(StationProcessFSM):
    ...
    def __init__(self, station: Station, params_dict: Dict):
        ...
        transitions = [
            ...
            {'trigger':self._trigger_function, 'source':'unload_sample','dest':'update_batch_index', 'conditions':'is_station_job_ready'},
