...
class IKAStirPlateSm(StationProcessFSM):
    def __init__(self, station: Station, params_dict: Dict):
        ...
        transitions = [
            ...
            },
            {
                ...
                "dest": "place_8_well_rack",
                "conditions": "all_batches_assigned",
            },
            {
                "trigger": self._trigger_function,
                "source": "place_8_well_rack",
                "dest": "place_pxrd_rack",
                "conditions": "is_station_job_ready",
            },
            {
                "trigger": self._trigger_function,
                "source": "place_pxrd_rack",
                "dest": "load_stir_plate",
                "conditions": "is_station_job_ready",
            },
            {
                "trigger": self._trigger_function,
                "source": "load_stir_plate",
                "dest": "stir",
                "conditions": "is_station_job_ready",
            },
            {
    ...
    def request_load_stir_plate(self):
        robot_job = YuMiRobotTask.from_args(
            name="loadIKAPlate", location=self._station.location
        )
        current_batch_id = self._station.assigned_batches[
            self._status["batch_index"]
        ].id
