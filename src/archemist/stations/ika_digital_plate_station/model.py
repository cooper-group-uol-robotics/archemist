...
class IkaDigitalPlateStationModel(StationModel):
    ...
    current_temperature = fields.IntField(
        min_value=0, max_value=500, null=True)
    current_stirring_speed = fields.IntField(
        min_value=0, max_value=1500, null=True)
    external_temperature = fields.IntField(
        min_value=0, max_value=500, null=True)
