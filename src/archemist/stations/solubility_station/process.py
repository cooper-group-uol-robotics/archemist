...
class SolubilityStationSM(StationProcessFSM):
    def __init__(self, station: Station, params_dict: Dict):
        ...
        transitions = [
            ...
            },
            {
                "trigger": self._trigger_function,
                "source": "unload_sample",
                "dest": "update_batch_index",
                "conditions": ["are_all_samples_loaded", "is_station_job_ready"],
                "before": "reset_station",
            },
            {
                "trigger": self._trigger_function,
                "source": "update_batch_index",
                "dest": "load_sample",
                "conditions": "is_station_job_ready",
            ...
            },
            {
                ...
                "source": "update_batch_index",
                "dest": "final_state",
                "conditions": ["are_all_batches_processed", "is_station_job_ready"],
            },
        ]
    ...
    def request_load_sample_job(self):
        ...
        robot_job = PandaRobotTask.from_args(
            name="PresentVial",
            params=[self._status["batch_index"] + 1, sample_index],
