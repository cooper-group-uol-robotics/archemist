...
class QuantosSolidDispenserQB1ROSHandler(StationHandler):
    ...
    def execute_op(self):
        ...
        self._results_wating = Thread(target = self._is_op_execution_complete, daemon= True)
    ...
    def get_op_result(self) -> Tuple[bool, Dict]:
        return self._op_results.pop("success", None), self._op_results

    def _is_op_execution_complete(self):
