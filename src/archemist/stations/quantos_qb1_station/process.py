...
from .state import  QuantosSolidDispenserQB1, DispenseOpDescriptor, OpenDoorOpDescriptor, CloseDoorOpDescriptor
...
class QuantosQb1StationProcess(StationProcess):
    ...
    def __init__(self, station:  QuantosSolidDispenserQB1, process_data: StationProcessData, **kwargs): 
        ...
        transitions = [
            ...
            {'source':'open_quantos_door','dest':'unload_vial', 'conditions':'are_req_robot_ops_completed'},
            {'source':'unload_vial','dest':'unload_cartridge', 'conditions':'are_req_robot_ops_completed'},
            {'source':'unload_cartridge','dest':'final_state', 'conditions':'are_req_station_ops_completed'}
        ]
