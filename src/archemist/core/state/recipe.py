...
class Recipe:
    def __init__(self, recipe_model: RecipeModel):
        ...
        self._station_sm = Machine(
            states=self._model.states,
            initial=self._model.current_state,
